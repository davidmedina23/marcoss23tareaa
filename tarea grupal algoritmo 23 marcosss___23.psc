...
FinFuncion 
	...
	Algoritmo MenuPrincipal
		...
		Escribir "            este es el Deber de algoritmo de MARCOS___23 <3   "
		Escribir "                ***   ***                                                   "
		Escribir "               ***** *****                                                   "
		Escribir "               **********                                                     "
		Escribir "                 ******                                                    "
		Escribir "                  ***                                                    "
		Escribir "                   *                                                     "
		Escribir "            ingresa cualquier numero para entrar al menu <3"
		Leer PPP
		Repetir
			Borrar Pantalla
			Escribir "Menú Principal"
			Escribir "1) Números<3"
			Escribir "2) Cadenas<3"
			Escribir "3) Arreglo<3s"
			Escribir "4) Salir</3"
			...
			Segun opcionPrincipal Hacer
				1:
					Repetir
						...
						Escribir "1) Operaciones Selectivas <3"
						Escribir "2) Operaciones Colectivas <3"
						Escribir "23) para salir al Menú Principal tiene que entrar "
				...
				2:
					Repetir
						...
						Escribir "3)para salir al Menú Principal tiene que entrar  "
						Escribir "Elija una opción [1...3]: "
						Leer opcionCadenas
						...
						Segun ppp Hacer
							...
							23:
								Borrar Pantalla
								Escribir" digita cualquier dato o numero y regresaras al menu  "
								Leer opcionEjercicio// Romper // Salir del bucle
							De Otro Modo:
								Escribir "Opción inválida...<3"
						FinSegun
						Esperar 2 Segundos
				...
				3:
					Repetir
						...
						Escribir "Elija una opción [1...3]: "
						Leer opcionArreglos
						Escribir "digite del 12 hasta el  23 : 32 para salir "
				...
				4:
					Escribir "Gracias por usar el sistema de Marcoss___23 . Saliendo..."
				De Otro Modo:
					Escribir "Opción inválida...<3"
			FinSegun
